...
const AdminDashboardPage = () => {
    ...
    const loadData = async () => {
        try {
            ...
            // Load moderators using Appwrite
            try {
            ...
            // Load audio files for Gallery tab
            try {
    ...
    const handleDeleteAudio = async (audioId, audioName) => {
        if (!window.confirm(`Are you sure you want to delete "${audioName}"?`)) {
            return;
        }
                                    ...
                                    <div className="admin-grid-layout" style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '2rem' }}>
                                        ...
                                        <div className="upload-section subsection">
                                            <BookUpload onUploadSuccess={() => {
                                                success('Book uploaded successfully! It will appear in the Digital Library.');
                                                loadData();
                                            }} />
                                        </div>
                                    ...
                                    <div className="media-upload-grid">
                                        ...
                                        <div className="upload-section">
                                            <ImageUpload onUploadComplete={() => {
                                                success('Images uploaded! They will appear in Photo Gallery.');
                                            }} />
                                        </div>

                                        {/* Audio Upload Section */}
                                        <div className="upload-section">
                                            <AudioUpload onUploadComplete={() => {
                                                success('Audio uploaded! It will appear in Audio Gallery.');
                                                loadData(); // Refresh to show new audio
                                            }} />
                                        </div>
                                    </div>
                                                            ...
                                                            <div>
                                                                ...
                                                                <div style={{ fontSize: '0.8rem', color: '#666' }}>
                                                                    <span style={{
                                                                        ...
                                                                        padding: '2px 8px',
                                                                        borderRadius: '12px',
                                                                        background: audio.isNamaJapa ? 'rgba(255,153,51,0.15)' : 'rgba(76,175,80,0.15)',
